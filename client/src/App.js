...
function App(props) {
  return (
    <BrowserRouter>
    <div>
    <Navbar style={{ backgroundColor: '#155', borderColor: '#420' }} light expand="md" className="mb-5">
      <NavbarBrand style={{color:"white"}}>Ticket Master</NavbarBrand>
      <Nav className="ml-auto" navbar>
        <NavItem >
          <Link className="nav-link text-primary" to="/"style={{color:"#ffffff"}}>Home</Link>
        </NavItem>
        {Object.keys(props.user).length !== 0 &&
        <React.Fragment>
        <NavItem>
          <Link className="nav-link text-primary" to="/customers" style={{color:"white"}}>Customers</Link>
        </NavItem>
        <NavItem>
          <Link className="nav-link text-primary" to="/departments" style={{color:"white"}}>Departments</Link>
        </NavItem>
        <NavItem>
          <Link className="nav-link text-primary" to="/employees"style={{color:"white"}}>Employees</Link>
        </NavItem>
        <NavItem>
          <Link className="nav-link text-primary" to="/tickets"style={{color:"white"}}>Tickets</Link>
        </NavItem>
        </React.Fragment>
        }
        {Object.keys(props.user).length == 0 ? (
